...
| --- | --- | --- | --- |
| `arbitration_ip` | model | stale — arbitration_ip.template.yaml changed since this review; a fresh round is owed | - |
| `completion_ip` | model | stale — completion_ip.template.yaml changed since this review; a fresh round is owed | M37 (superseded) |
