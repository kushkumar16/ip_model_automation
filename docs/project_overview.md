...
`python tools/run_ci.py` runs all ten repo-wide gates in about a minute, and
...
| --- | --- | --- | --- |
| `arbitration_ip` | model | stale — test_arbitration_ip.py changed since this review; a fresh round is owed | M42 (superseded) |
