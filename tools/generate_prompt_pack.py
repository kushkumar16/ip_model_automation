...
def render_prompt_pack(template: dict[str, Any], template_path: Path) -> str:
    ...
    lines: list[str] = [
        ...
        "- Do not invent FSMs, protocols, queues, resources, timing values, side effects, or tests not represented in the template.",
    ...
    lines.extend(
        [
            ...
            f"python tools\\generate_model_scaffold.py templates\\{ip_name}.template.yaml --output-dir src\\ip_model_automation",
