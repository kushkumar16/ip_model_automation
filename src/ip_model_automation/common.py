...
IP_ARTIFACTS: Dict[str, IpArtifact] = {
    "arbitration_ip": IpArtifact("arbitration_ip", "docs/arbitration_ip_dld.md", "templates/arbitration_ip.template.yaml"),
    "completion_ip": IpArtifact("completion_ip", "docs/completion_ip_dld.md", "templates/completion_ip.template.yaml"),
    "gdma_ip": IpArtifact("gdma_ip", "docs/gdma_ip_dld.md", "templates/gdma_ip.template.yaml"),
    "timer_ip": IpArtifact("timer_ip", "docs/timer_ip_dld.md", "templates/timer_ip.template.yaml"),
    "axi_interconnect_ip": IpArtifact("axi_interconnect_ip", "docs/axi_interconnect_ip_dld.md", "templates/axi_interconnect_ip.template.yaml"),
    ...
    "dma_subsystem": IpArtifact("dma_subsystem", "docs/dma_subsystem_dld.md", "templates/dma_subsystem.template.yaml"),
    "mailbox_irq_subsystem": IpArtifact(
        "mailbox_irq_subsystem",
        "docs/mailbox_irq_subsystem_dld.md",
