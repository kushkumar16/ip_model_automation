...
- Note: configuration is applied by the refill process; the writer waits in
  REFILL_BASE until config_applied comes back
...
> Content preserved from completion_ip_dld.src.md that did not map to an
> extractor convention. Review and either place it or confirm it is out of scope.
